...
class ManuscriptControllerTest extends ControllerBaseCase {
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/manuscript/typeahead?q=STUFF');
...
//        $this->assertEquals('application/json', $response->headers->get('content-type'));
    ...
    public function testAdminNewPopup() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/manuscript/new_popup');
        $this->assertSame(200, $this->client->getResponse()->getStatusCode());
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->entityManager->getRepository(Manuscript::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/manuscript/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(Manuscript::class)->findAll());
