...
class FeatureRepositoryTest extends ServiceTestCase {
    private const TYPEAHEAD_QUERY = 'label';

    private FeatureRepository $repo;

    public function testSetUp() : void {
        $this->assertInstanceOf(FeatureRepository::class, $this->repo);
    }
    ...
    protected function setUp() : void {
        parent::setUp();
        $this->repo = self::getContainer()->get(FeatureRepository::class);
    }
}
