 ...
 *
 */
class LoadAppBundleEntityManuscriptRole extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference('_reference_AppBundleEntityManuscriptRole1', $item1);
