 ...
 *
 */
class LoadAppBundleEntityContent extends AbstractFixture implements OrderedFixtureInterface
{
...
<p>&nbsp;</p>");
        ...
        $item1->setPrintSource($this->getReference('_reference_AppBundleEntityPrintSource1'));
        $item1->setCreated(new \DateTime("2019-07-29 22:41:59"));
        $item1->setUpdated(new \DateTime("2019-07-29 22:41:59"));
        $this->addReference('_reference_AppBundleEntityContent1', $item1);
